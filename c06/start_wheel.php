...
<body ontouchstart="">
	<div class="mainwrapper">
		<div class="main-wrapper">
			...
			<p class="title text-center">C06 Trade BAT Program</p>
			...
			<!-- <h2 style="color:white;" class="noSpins"></h2> -->
			<!-- <label for="" class="noSpins"></label> -->
			<!-- <input type="text" class="noSpins" readonly> -->
			...
			<!-- <h1 style="color:white;" class="noSpins text-center">/<?php echo $total_spins ?></h1>
			<input type="text" class="noSpins" id="spinsnum" value="<?php echo $total_spins ?>"> -->
			<!-- <h1 class="numberSpin"></h1> -->
			...
			<div class="modal-dialog">
		    	<div class="modal-content text-center">
					...
					<?php  }else { ?>
						<div class="modal-footer text-center">
							<!-- <?php
							//  echo "<a style='background-color:#a71c20;border:#270106;border:#7d0211;' class='btn btn-back' id='nextpage' href='./term.php?prodID=2'>Next</a> ";?>  -->
	...
	$(document).ready(function() {
		...
		$.ajax({
			...
			success: function (response) {
				...
				html += ` ${response}`
				// html += ` ${response}/ <?php echo $total_spins ?>`
				modalspin += ` ${response}`
				$(".noSpins").html(html);
